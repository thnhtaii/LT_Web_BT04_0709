...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom flex-wrap gap-2">
            <ul class="nav nav-pills gap-2">
                ...
                <li class="nav-item">
                    <a class="nav-link active rounded-pill px-3" href="<c:url value='/admin/products'/>">
        ...
        <div class="page-header-box">
            <div>
                ...
                <p class="page-subtitle">Xem, quản lý và chỉnh sửa toàn bộ các mặt hàng sản phẩm của DT SHOP</p>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-2">
                                                ...
                                                <button type="button" 
                                                        class="btn btn-sm btn-outline-danger rounded-pill px-3 btn-delete-product" 
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#deleteProductModal" 
                                                        data-name="${prod.productName}" 
                                                        data-url="<c:url value='/admin/product/delete?id=${prod.productId}'/>">
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mb-0">Chưa có sản phẩm nào. Hãy bấm <strong>Thêm Sản Phẩm Mới</strong> để tạo!</p>
                                    </td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
    ...
    <div class="modal fade" id="deleteProductModal" tabindex="-1" aria-labelledby="deleteModalTitle" aria-hidden="true">
            ...
            <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a id="btnConfirmDeleteProd" href="#" class="btn btn-danger rounded-pill px-4 fw-bold shadow-sm">
                            <i class="fa-solid fa-trash-can me-1"></i> Xóa Sản Phẩm
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var deleteProdBtns = document.querySelectorAll('.btn-delete-product');
            var modalMsg = document.getElementById('deleteModalMessage');
            var confirmBtn = document.getElementById('btnConfirmDeleteProd');

            deleteProdBtns.forEach(function(btn) {
                btn.addEventListener('click', function() {
                    var prodName = btn.getAttribute('data-name');
                    var deleteUrl = btn.getAttribute('data-url');
                    if (modalMsg) {
                        modalMsg.innerHTML = 'Bạn có chắc chắn muốn xóa sản phẩm <strong class="text-danger">[' + prodName + ']</strong> không?<br><span class="small text-muted">Hành động này sẽ xóa vĩnh viễn sản phẩm khỏi kho hàng.</span>';
                    }
                    if (confirmBtn) {
